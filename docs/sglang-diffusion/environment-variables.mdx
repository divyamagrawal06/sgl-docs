...
SGLang supports multiple caching strategies - see [performance optimization documentation](/docs/sglang-diffusion/performance-optimization) for an overview.

See [Environment Variables](/docs/references/environment_variables) for a list of all environment variables.

## Cache-DiT configuration

See [Cache-DiT documentation](/docs/sglang-diffusion/cache-dit) for detailed configuration.
